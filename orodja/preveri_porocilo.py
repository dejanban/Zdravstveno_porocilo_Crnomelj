...
with sync_playwright() as pw:
    ...
    expected=json.loads((P/'podatki/register/statistika-registra.json').read_text(encoding='utf-8'))['pripadnost']['Črnomelj']
...
d=fitz.open(P/'porocilo.pdf');print(json.dumps({'strani_pdf':len(d),'grafi':11,'viri':len(json.loads((P/'podatki/literatura/literatura.json').read_text(encoding='utf-8'))),'preverjanje':'Uspešno: povezave, 5 širin, JavaScript, filtri, drsnik.'},ensure_ascii=False));d.close()
