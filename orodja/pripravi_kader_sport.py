...
refs=sources(); source=(P/'vsebina/kader-sport-vsebina.md').read_text(encoding='utf-8')
...
(P/'vsebina/kader-sport.html').write_text(html,encoding='utf-8')
...
if '{{kader-sport}}' not in body:
    ...
    (P/'vsebina/vsebina.html').write_text(body,encoding='utf-8')
