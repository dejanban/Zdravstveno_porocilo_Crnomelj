...
d=json.loads((P/'podatki/poti/poti-podatki.json').read_text(encoding='utf-8'))
manifest=json.loads((P/'podatki/poti/poti-manifest.json').read_text(encoding='utf-8'))['datoteke']
...
ET.parse(P/'podatki/poti/poti-zemljevid.svg')
errors=[];requests=[]
