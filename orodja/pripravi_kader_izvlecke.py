...
refs=json.loads((P/'podatki/kader/kader-sport-viri.json').read_text(encoding='utf-8'))
...
(P/'podatki/kader/kader-zzzs-20260901.json').write_text(json.dumps(data,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
...
(P/'podatki/kader/kader-sport-viri.json').write_text(json.dumps(refs,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
