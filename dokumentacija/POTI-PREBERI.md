...
```powershell
python -X utf8 orodja/analiziraj_poti.py
python -X utf8 orodja/pripravi_poti.py
python -X utf8 orodja/zgradi_porocilo.py
python -X utf8 orodja/preveri_poti.py
python -X utf8 orodja/preveri_porocilo.py
```
