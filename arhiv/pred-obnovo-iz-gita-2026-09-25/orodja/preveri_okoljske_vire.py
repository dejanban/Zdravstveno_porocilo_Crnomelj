...
report['status']='opozorilo: podedovana neskladja' if report['inherited_unresolved'] else 'uspesno'
(P/'preverjanje/kontrolne-vsote.json').write_text(json.dumps(report,ensure_ascii=False,indent=2),encoding='utf-8')
print(json.dumps(report,ensure_ascii=False,indent=2))
print('Podedovana neskladja niso potrjeni izvirniki. Stari prazni viri niso potrjeni.')
