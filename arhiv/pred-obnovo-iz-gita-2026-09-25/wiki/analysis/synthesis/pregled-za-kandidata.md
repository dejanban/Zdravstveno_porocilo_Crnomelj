# Pregled za kandidata

Zadnja posodobitev: 25. september 2026. Obnovljen je okoljski del in dodana sinteza spanja; stare prazne sinteze drugih tem niso rekonstruirane. Okoljski dokazi, definicije, ocene in literatura: [[../../topics/environment/zivljenjske-razmere-voda-zrak.md]].
...
| ⚠️ Spanje in digitalne navade, 3,00/5 za dokumentiranost in pripravljenost spremljanja | Raziskovalni pregled loči starosti, vrste uporabe in povezave od vzročnosti; objave NIJZ omogočajo skupno izobraževalno podlago. | Ni lokalne primerljive meritve; štirje članki so prebrani samo kot povzetki; poseben učinek posameznih platform ni določen. | V prvem letu pripraviti skupen načrt CKZ, šol in NIJZ; v mandatu spremljati agregirane izide po 6/12 mesecih in ovire za vključevanje. Dokazi in izračun: [[../../topics/social-affairs/spanje-digitalne-navade.md]]. |
