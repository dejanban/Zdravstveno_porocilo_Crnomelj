...
def save(key,original,title,body):
    r=dict(refs[original]);r['title']=title;r['local']=f'raw/web/kader-sport-20260921-{key}.md'
    dst=ROOT/r['local']
    if not dst.exists():
...
body+='\n\nCelotna preglednica: porocila/zdravstvo-obcina-crnomelj/viri/kader-sport-zzzs.xlsx. Uporabljene izvirne vrstice 1330–1338. Izvirna glava in pojasnila tudi v kader-sport-20260921-zzzsdata.md. GK pomeni glavarinski količnik, ne števila ljudi.\n'
