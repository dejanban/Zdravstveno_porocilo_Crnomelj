...
def get(item):
 ...
 local=f'raw/web/zdravstvo-20260920-drustva-{key}.md'
...
if __name__=='__main__':
 ...
 (P/'drustva-viri.json').write_text(json.dumps(refs,ensure_ascii=False,indent=2),encoding='utf-8');print('Napake',errors,flush=True)
