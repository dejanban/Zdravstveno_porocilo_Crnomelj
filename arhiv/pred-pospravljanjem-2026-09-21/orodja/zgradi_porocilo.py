...
def sources():
    ...
    refs['nizi']={'title':'Časovni nizi kazalnikov za Črnomelj, izdaje 2016–2026: 54 Excelovih datotek','publisher':'NIJZ','date':'2026','url':'https://obcine.nijz.si/obcine/crnomelj/17/2026/','local':'viri/nijz','note':'Lokalni izvirniki XLSX; izvoz v kazalniki.csv. Leto v nizu pomeni leto objave.'}
