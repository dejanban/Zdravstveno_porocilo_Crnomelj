...
naslov: Interventions for preventing obesity in children (povzetek v preprostem jeziku)
izdajatelj: Cochrane Database of Systematic Reviews
avtorji: T. Brown in sod.
datum objave: 2019
dostopano: 2026-09-26
metoda zajema: prenos izvirnika (viri/teme-2026-09-26/cochrane-debelost-otroci.html), strojni izvleček besedila
obseg branja: Povzetek v preprostem jeziku.
zanesljivost: visoka (sistematični pregled 153 RCT; prebran povzetek)
---
...
Children aged 0-5 years: There is moderate-certainty evidence from 16 RCTs (n = 6261) that diet combined with physical activity interventions, compared with control, reduced BMI (mean difference (MD) −0.07 kg/m
2
, 95% confidence interval (CI) −0.14 to −0.01), and had a similar effect (11 RCTs, n = 5536) on zBMI (MD −0.11, 95% CI −0.21 to 0.01). Neither diet (moderate-certainty evidence) nor physical activity interventions alone (high-certainty evidence) compared with control reduced BMI (physical activity alone: MD −0.22 kg/m
2
, 95% CI −0.44 to 0.01) or zBMI (diet alone: MD −0.14, 95% CI −0.32 to 0.04; physical activity alone: MD 0.01, 95% CI −0.10 to 0.13) in children aged 0-5 years.
Children aged 6 to 12 years: There is moderate-certainty evidence from 14 RCTs (n = 16,410) that physical activity interventions, compared with control, reduced BMI (MD −0.10 kg/m
2
