---
url: https://zd-crnomelj.si/upravljanje-in-vodenje/
naslov: Upravljanje in vodenje
izdajatelj: Zdravstveni dom Črnomelj
datum objave: b.d.
dostopano: 2026-09-25
metoda zajema: curl (lokalni izvirnik viri/posodobitve-2026-09-25/zd-upravljanje.html), besedilo izluščeno z BeautifulSoup; prebrano v celoti
zanesljivost: visoka (uradna stran zavoda; stanje na dan zajema)
---
...
Člani sveta zavoda ZD Črnomelj v mandatu 2024– 2028 so:
Katja Pezdirc, predsednica (predstavnica ZD Črnomelj)
Sonja Ličen Tesari, podpredsednica (predstavnica občine Semič)
Mateja Perak, članica (predstavnica občine Črnomelj)
Samer Khalil, član (predstavnik občine Črnomelj)
Tamara Potočar, članica (predstavnica občine Črnomelj)
Branka Gril Hudoklin, članica (predstavnica ZZZS)
Mirela Mićić Despotović, članica (predstavnica ZD Črnomelj)
VODSTVO ZAVODA
V.D. direktorja zavoda
je Jožica Fortun Tomažič, dr.med.spec.spl.med.
